...
function SnippetsPage() {
  ...
  if (snippets === undefined) {
    return (
      <div className="min-h-screen">
         ...
         {/* on the top we would like to se the navigation header */}
        <NavigationHeader />
  ...
  const filteredSnippets = snippets.filter((snippet) => {
    const matchesSearch =
      ...
      // if the lang is not selected fetch all 
    const matchesLanguage = !selectedLanguage || snippet.language === selectedLanguage;

    return matchesSearch && matchesLanguage;
    // return true if matchesSearch and matchesLanguage 
    // now we can see the  language of the snippet and its on the display
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        {/* Hero- we have a motion div add mutiple classes to make it look cool*/}
        ...
        <div className="relative max-w-5xl mx-auto mb-12 space-y-6"> 
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            {/*popular lang array will be holding the languages- put alll lang in a set and then map for it  */}
        ...
        {/* Snippets Grid-- by default grid , large  3 and in list one of them at a time  */}
        <motion.div
        ...
        >
          <AnimatePresence mode="popLayout">
            ...
            {filteredSnippets.map((snippet) => (
              <SnippetCard key={snippet._id} snippet={snippet} /> //_id is how convex stores id 
            ))}
          </AnimatePresence>
        </motion.div>
